...
<div style="background: linear-gradient(135deg, #ede5f8 0%, #d4bef0 100%); padding: 28px 36px; border-radius: 12px; border-bottom: 4px solid #802cd7; margin-bottom: 24px; display:flex; align-items:flex-end; justify-content:space-between; gap:24px; flex-wrap:wrap;">
    <div>
        <h1 style="color: #211030; font-size: 1.7rem; font-weight: 700; margin: 0;">🚀 Major IT Development Projects</h1>
        <p style="color: #6321a5; font-size: 0.95rem; margin: 4px 0 0 0;">Track active MITDPs across Maryland state agencies</p>
    </div>
</div>
...
## Project Timeline - Click on project to see its details
