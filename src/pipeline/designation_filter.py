...
class DesignationFilter:
    ...
    def __init__(self, config: dict[str, Any]):
        ...
        logger.info(
            ...
            [d["id"] for d in self._designations],
        )
    ...
    def _designation_match_expr(self, designation: dict[str, Any]) -> pl.Expr:
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        type=str,
        default=str(CONFIG_DIR / "it_programs.yaml"),
        help="Config YAML with it_programs.designations",
    )
    parser.add_argument(
        "--output",
        type=str,
