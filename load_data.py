...
Usage:
    python load_data.py
    python load_data.py --input data/enriched/budget_enriched.csv
...
def load(input_path: str, db_path: str = "mbtsa.duckdb"):
    ...
    if input_path.suffix in (".xlsx", ".xls"):
        # DuckDB can read Excel natively via spatial extension
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input",
        default="data/enriched/budget_enriched.parquet",
